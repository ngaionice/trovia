...
public class Regexes {
    ...
    public String gearStyleCat = "[0-9A-F]4 (?:0[0-7] )?08 [0-9A-F][0-9A-F] ((?:[0-9A-F][0-9A-F] )+?)BE 01 [0-9A-F]E ((?:[0-9A-F][0-9A-F] (?:[0-9A-F][0-9A-F] )?)?)00 ((?:[0-9A-F]4 (?:[0-9][0-9A-F] )?08 [0-9A-F][0-9A-F] (?:(?:[0-9A-F][0-9A-F] )+?)18 (?:00 |(?:[0-9A-F][0-9A-F] (?:(?:[0-9A-F][0-9A-F] )+?)))28 (?:00 |(?:[0-9A-F][0-9A-F] (?:(?:[0-9A-F][0-9A-F] )+?)))30 [0-9A-F][0-9A-F] BE 04 08 00 08 58 (?:00 |(?:(?:[0-9A-F][0-9A-F] )+?))68 00 1E )*?)08 1E";
    public String gearStyleExtractor = "[0-9A-F]4 (?:[0-9][0-9A-F] )?08 [0-9A-F][0-9A-F] ((?:[0-9A-F][0-9A-F] )+?)18 (00 |(?:[0-9A-F][0-9A-F] ((?:[0-9A-F][0-9A-F] )+?)))28 (00 |(?:[0-9A-F][0-9A-F] ((?:[0-9A-F][0-9A-F] )+?)))30 [0-9A-F][0-9A-F] BE 04 08 00 08 58 (00 |(?:(?:[0-9A-F][0-9A-F] )+?))68 00 1E";
