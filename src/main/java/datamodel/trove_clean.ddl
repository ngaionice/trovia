...
--GO
create table Object (
    rel_path TEXT references Article on update cascade on delete cascade primary key,
    updated TEXT not null,
...
create table BenchCategory (
    ...
    bench_index INT unique not null,
    updated TEXT not null,
...
create table Recipe (
    ...
    bench_id TEXT references Bench(name_id) on update cascade on delete cascade,
...
create table RecipeOutput (
    ...
    updated TEXT not null,
    primary key (rel_path, output_rel),
