...
public class LanguageManager implements Manager, Serializable {
    ...
    public Map<String, String> getAllStringsByFile(String rPath) {
    ...
    public Map<String, LangFile> getAllFiles() {
        return langFileMap;
    }

    public Map<String, LangFile> getNewFiles() {
        return addMap;
    }

    public Map<String, LangFile> getRemovedFiles() {
        return removeMap;
    }

    public Map<String, String> getNewStrings() {
        return addStringMap;
    }

    public Map<String, String> getRemovedStrings() {
        return removeStringMap;
    }
