...
public class Splitter {
    ...
    static String hexAlphabetExtended = "0A|[4][1-9A-F]|[5][0-9A]|[6][0-9A-F]|[7][0-9A]|2[017CE]|3[AF]|5[CF]"; // period, space, newline, exclaim/question marks, backslash, underscore
...
//        String subHexString = hexString.substring(hexString.indexOf("24 70"));
        ...
        String description = "64 65 73 63 72 69 70 74 69 6F 6E";
